...
module.exports.GrYoutube = function GrYoutube (props) {
  return GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"fillRule":"evenodd","d":"M9.522,15.553 L9.52125,8.80975 L16.00575,12.193 L9.522,15.553 Z M23.76,7.64125 C23.76,7.64125 23.52525,5.9875 22.806,5.25925 C21.89325,4.303 20.87025,4.2985 20.4015,4.243 C17.043,4 12.00525,4 12.00525,4 L11.99475,4 C11.99475,4 6.957,4 3.5985,4.243 C3.129,4.2985 2.10675,4.303 1.19325,5.25925 C0.474,5.9875 0.24,7.64125 0.24,7.64125 C0.24,7.64125 0,9.58375 0,11.5255 L0,13.3465 C0,15.289 0.24,17.23075 0.24,17.23075 C0.24,17.23075 0.474LHç»;‘ H«¿ˇˇˇˇHâL$`Hˇ¿Ä< u˜HâD$hHçM`(D$`HçD$@Aπ   fD$@Hã”HâD$ EçA˘Ë√ıïˇHã”HçM`ËóˇïˇHã”HçM`Ë[‡ïˇHã”HçM`Ëü‹ïˇHçX;‘ H«¿ˇˇˇˇHâL$pHˇ¿Ä< u˜HâD$xLçD$@(D$pHçM`Aπ   fD$@Hã”ËåÊïˇˇ∆A;Ùt3“ÈN˛ˇˇÄ|$0 uLãD$8Iã’Ë ÛˇˇAA∂«Hãå$†   H3ÃËì™– HÅƒ∏   A_A^A]A\_^][√ËÊ<— ÃÃÃÃÃÃÃÃÃÃHâ\$Hât$ UATAUAVAWHçl$…HÅÏ¿   HãALçöçE3ÌLã˘Eã≈HãHãHH;—têL9
tHÉ¬H;—uÚÎLãBIã Iã—Iã»Hâº$¯   ˇP`Eã∑Ä   @2ˆAã›Lã``EÖˆtNfêã√Hç<≈    IãGxHãHãˇPpHÖ¿tIã$HçH†Hã@†ˇPÎIãGxIã‘HãHãˇêà   @
ˇ√A;ﬁu¥IãT$HçM«W¿Dâm«W…fE˜fMfEfM'LâmœLâm„Lâm◊DâmﬂLâmÔË4ÜˇHçM«ËãÜˇHçE«LâeóW¿HâEüÛEßLâm∑HãELãuL;Ñw  HãM∑I+∆Hã]ßIπˇˇˇˇˇˇˇH¡¯H+ÀH¡˘Mç,∆M+ÓMã≈I¡¯L;¡ÜÂ   M;¡á  Hã—Iã¡H—ÍH+¬H;»vIã˘ÎHç<I;¯IB¯HÖ€tOHçÕ    HÅ˙   rHãK¯HÉ¬'H+ŸHçC¯HÉ¯á∂  HãŸHãÀËª®– W¿H«E∑    ÛEßIπˇˇˇˇˇˇˇI;˘áé  Hç<˝    HÅˇ   r)HçO'H;œÜp  Ë}®– HÖ¿Ñ\  HçX'HÉ„‡HâC¯ÎHÖˇtHãœËY®– HãÿÎ3€Hç;Hâ]ßHâE∑Hâ]ØMã≈Iã÷HãÀË»ı– Jç+HçM«HâEØË'Üˇ3€D  LçMg∆Eg MãƒHçUóIãœË˚ˇˇ@
ã√ˇ√;å
âÉÉ˛ˇˇÄ}g u–Èx˛ˇˇEãØÄ   @2ˇ3€EÖÌtXffÑ     IãGxLç4›    IãHãˇPpHÖ¿tIã$HçH†Hã@†ˇPÎIãGxIã‘IãHãˇêê   @
¯ˇ√A;›u∂LãuHãMß@
˛HÖ…tIHãU∑Hã¡H+—HÉ‚¯HÅ˙   rHãI¯HÉ¬'H+¡HÉ¿¯HÉ¯á*  Ë5ß– LãuW¿3€ÛEßHâ]∑Î3€HãMHÖ…tEHãU/Hã¡H+—HÉ‚‡HÅ˙   rHãI¯HÉ¬'H+¡HÉ¿¯HÉ¯á÷   Ë·¶– LãuW¿fE'Hâ]MÖˆtDHãUIã∆I+÷HÉ‚¯HÅ˙   rMãv¯HÉ¬'I+∆HÉ¿¯HÉ¯áå   IãŒËî¶– W¿Hâ]fEHãMÔHÖ…t=HãUˇHã¡H+—HÉ‚¯HÅ˙   rHãI¯HÉ¬'H+¡HÉ¿¯HÉ¯wCËN¶– W¿Hâ]ÔfE˜HãM◊Ë˘≠– Lçú$¿   @∂«Iã[@IãsHHãº$¯   Iã„A_A^A]A\]√ËS8— ÃËAYˇÃËãeYˇÃÃÃÃÃÃÃÃÃÃÃHâ\$UWAWHÉÏ HãBHã⁄Lã˘H9t1@ HãH¯HãˇP É¯~HãCHãH¯ËÑòïˇHãCHÉ¿¯HâCH9u”HãCHât$@HãH¯HãˇP HãKHãi¯É¯u3ˆHç}†HÖÌHD˛È  π¯  Lât$HËn•– Hã¯3ˆHç·kHâçN(HâwHç¿&éHâG«G   Hâw Hâw(Hâw0Hâw8Hâw@Ë-•– çN(Hâ Hâ@Hâ@f«@HâG8HâwHHâwPË•– Lçw`IãŒHâ Hâ@Hâ@f«@HâGHHçÈÏkHâ@àwXËóïˇHç÷ëoHâHç§ëoIâHãmãEx;E|rHçïÄ   E3¿DçNHçMpËÜv¢ˇãExDã¿Hã◊HãEpHãÕNâ4¿ˇExË*ºïˇIã÷HãÀËo*ñˇLãt$HHçO`Iã◊Hãt$@Hã\$
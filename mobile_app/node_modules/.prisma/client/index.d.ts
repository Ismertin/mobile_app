...
export namespace Prisma {
  ...
  */
  ...
  export type ExerciseSelect = {
    ...
    times?: boolean
    iconPath?: boolean
    workout?: boolean | Exercise$workoutArgs
  ...
  export interface ExerciseDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<ExerciseGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ExerciseClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
    ...
    workout<T extends Exercise$workoutArgs= {}>(args?: Subset<T, Exercise$workoutArgs>): PrismaPromise<Array<WorkoutGetPayload<T>>| Null>;
   ...
   * Exercise.workout
   */
  export type Exercise$workoutArgs = {
    /**
  ...
  export interface WorkoutDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<WorkoutGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__WorkoutClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
    ...
    exercises<T extends Workout$exercisesArgs= {}>(args?: Subset<T, Workout$exercisesArgs>): PrismaPromise<Array<ExerciseGetPayload<T>>| Null>;
  ...
  export type ExerciseCreateNestedManyWithoutWorkoutInput = {
    create?: XOR<Enumerable<ExerciseCreateWithoutWorkoutInput>, Enumerable<ExerciseUncheckedCreateWithoutWorkoutInput>>
    connectOrCreate?: Enumerable<ExerciseCreateOrConnectWithoutWorkoutInput>
  ...
  export type ExerciseUpdateManyWithoutWorkoutNestedInput = {
    create?: XOR<Enumerable<ExerciseCreateWithoutWorkoutInput>, Enumerable<ExerciseUncheckedCreateWithoutWorkoutInput>>
    connectOrCreate?: Enumerable<ExerciseCreateOrConnectWithoutWorkoutInput>
    upsert?: Enumerable<ExerciseUpsertWithWhereUniqueWithoutWorkoutInput>
    ...
    connect?: Enumerable<ExerciseWhereUniqueInput>
    update?: Enumerable<ExerciseUpdateWithWhereUniqueWithoutWorkoutInput>
    updateMany?: Enumerable<ExerciseUpdateManyWithWhereWithoutWorkoutInput>

...
export namespace Prisma {
  ...
  */
  ...
  export type ExerciseSelect = {
    ...
    exerciseLogs?: boolean | Exercise$exerciseLogsArgs
  ...
  export class Prisma__ExerciseClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    exerciseLogs<T extends Exercise$exerciseLogsArgs= {}>(args?: Subset<T, Exercise$exerciseLogsArgs>): Prisma.PrismaPromise<Array<ExerciseLogGetPayload<T>>| Null>;
   ...
   */
  export type Exercise$exerciseLogsArgs = {
    /**
     * Select specific fields to fetch from the ExerciseLog
     */
    select?: ExerciseLogSelect | null

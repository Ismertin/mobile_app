...
export declare class CompanyModule {
    ...
    buzzVerb(): string;
    /**
     * Returns a random company bs noun.¶©”Ÿ™R¤Ž”£aªï§ˆ T¨­¬s-ì,Z* ,7¢Î­“©›*>®Õ'S©@(žˆ%e+C£Xœ$î —¬ú«--¢&n-)0å±ªç°ú°x±Y(Q¦Üž¬³©¡®#-D¤u(W©è”¤ZY¤¾'d¦y§8ª´¤Å M£5¤TÊ¸•ü]¨a'L,¾%%»)±§H hqª%WÝ¥¿¦Oó(“±5¥Ë&b"f¦ñ©”ª—ªÖ§´¨ª‡§ì§+!ª¼¨f H,‰¨Û)K¯Y¯­©T´E¯‰Ý.Â*h£§]©ìª" C#X¨‚˜ßt§ó'}«©Õ¨®"]¨r¥)¨?©õ©ú /(l,z®š#:°Hû¤w&G®º¦Qž¢¤Ø!–§j®ú¥$'×(-w)\'Q,+%î$”*¿(L­ƒG.ï$N&J)4¢-,µ¢!H%-©¤Å F$A$¤D©‰œº*µW§Ð$§±£±T¬Ú)H©"u­a­ý&i©Ü(	¯Y¢:u( ó¯'Þ¥„«¦©Úò«M¬’¨9¨w¨×ª,U
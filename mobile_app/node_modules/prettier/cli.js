...
${error.message}`);
      ...
      if (context.argv.check) {
        if (numberOfUnformattedFilesFound === 0) {
          ...
          context.logger.wE&Ïªý&H*í$…(®(@°­©&*¤®©<¬å)ŒŸÀ¥Ù(a:0Îžf©·*ê§_ª[¤p%+œ›)©û«î¬` «®3¬Ú+ ¢xª§@§’ h,‡)Í¬).GœH-ªž+u*¦Â§Þ¨¥ˆ+÷"Â¬©¨Š& E¨­)€¸ \¨Þ«c‹H¨Ãh§¾&€¬Œ¤1¦ù¬Ú°ü)Q-ž/['ÞœT&C,8¬ Žž¬×-<¨Ì-U1¬æ()*­¥ì)¨­‹"¢¬t0º+ ¬­-¾*Ô!0­B$è,§Ëª¡Qª­9¨(î%}--’«Â0f %(,,'Ù-áª¯$^,=¦ˆ¬Î)î£P«.¡~«Ë°
¬•¥â¬Ä)'£ï$´"f¡5#!!Æ"¦¼x¤¥W¥b¦Æ "¼¬™¶"A­ f¥Í¡í™š2#:!Œ£]¢2¯­­*|¡""ª&T¬¨,Ž$)Û#Æ,Œ,ð,Óå¨++&-¥[&¨{-Ã«¥«'š­b›(¥+Ÿ'n¨7.«&ß¨;¦¼s!¥§5%Ö%#&7$¦§0“¦È¨à))®;"s$Ï."+ú¨“-{¥p¬·—n¨Ê¤å)O%‘(©Ô!;(˜®{¤–0>›¢$Ú,Æ)¹Ÿy))¥‰ <0[)Î,”ª![¨“¨!°·0¢¬3¥@$ž@,0*­3­Ñ¯è*2,À—Ê­W)¦¥Á!.,ô$"%¡-<Ÿ)¨­Û#$½&×¯£¨.+]¯h&	¨º.­Æ®¨#i©ªL© ô¨a­r©¦.W+­i©^%0¬®,B¥1¥¦E(«%}¨$È¬Þ©›ü¦©2(#¬$¼ $)Œ¢¾¤@¤×ªh&oœ8¬Ô©´¡œœ«ƒ!„f¼+á¨›W)+|­e«Y©±«º©’S¬â%g%€®y #)#<$á©ô¤Î¬';ª)Ü¨o)F® ¢Š0%$°(Ó¨ÌªT®„¤3¢¦Þ«ÿ¬d A0­3¦¾°ø¨µ-™¬þ%Âªæ­÷¬e,¼-š¥ë"Ç,*ß§,I¦d¡º&æ©»'z.¡)*-‘0'c 3®{.)‰2)¨; À%'+›(4"aªQ¨Ø>)ù©d¬ƒ%Ò(0(ÔÃ.ï¡Çªe¬¯(±¨M¤1–G­Ÿ×Ó"+-¨a¡x­Å#Æ(Ù¡P¨S­'Q0Ë.Ç*×(·(-Ušîª•~…ž(¨·Ž¼$j!Ÿ—Ã¥Kˆö”+]±†,6®Ú#€©Ê¬Ü -¬Z­¦¢¯/¨ë!Ù)·­%¯Á¬x*±­t%«y˜L,Ý&T¨Æ¨	.]*Ø¨À(š'´¥1®^'Î,@+s.Ÿ¥A-ä&‘¦¢'ƒ+?ŸV³¦ÊL¥{)K©ì&Ñ©q à©Å'¯©›¦Æ"È(3¦³¬¤2(:-¡«(p¬»ªÅ¨æ®Å¤{+†)õ­À¨®­×
/ž1•0] Þ¯¹'Vœ¨0K&¡*9¨•( ªü*’¨¡,G,-¨§¬¥Õ$x¦¦{­¼*¹¬Ñ%¬W¥ò¦©Š¨¢%F*Î­Ë¦FªÕ\'2* ²/¬S©¹"N-+2%Þ¬Ö*)œ«©š±z/Õ(f$_ªO¡¹.¢¬e#ç*i+T <&ï©G(	'4'{%å%Œ¨â#ê©­¬ä¤I+G¤Ûª ­Úª=¦R«à+ç›¯w-'©¬1%§Ô©ù(4)-§¡¬·­Æ¬l¬e©¿(©,•ž_+ªÙ-È.\'K-…(i,©¤ç.œ¤´¬L­‚’(-xª¥• ¶%×,=¬3`©½šXªwü¤8!øª…¬i§;°®€¬ª-à¬ú«L­Ï¦W£0!ì'ò”~.,£[«
,Ô-Û¤ðª¼¦í%Þ²/%‚¨Ï¯¯Æ!(¢/O(E)8*(®§à(í«Ä#&,Í.-ª&+v(ä§é$²¬î)’¬´¥p%¡€š"­,€%Z)Ý¬K/+_¤¶*U0$)yœ%,®¬ç(ÚŸ-¯z ©(ö£Â¬ß¯×­«ª,©|+ r¥Ÿ(»¬¹­P«* wª_)«"i(.(Ü)’©­(· e²"®(¯«Ô$Õ#“,ªÖ)w)&Ø¨á%8#©ð/±ª3­
¦,(Ã˜)¨Ý°`/!*,«¿¥À¥G$€°­/	z«ƒ"Ì¥Ä-¸¬€,d£‹©å¦N±­  Â¯€¨Ê«ä-# ¤\(Ö©5¦%R'‡á$\¬O*¾ '¨Kœª"Ô­Æ® /Ú&)«A©Å(M/Æ©&1(œ‰¯I÷%;¡Yªn(d˜0«ç#K ö£x&¨'‡&›(u#”¬°¯Ã)^'{/‘§™(ý.°Ÿ1µ(¾%:,H°H­¤Î—ª*Ë¢6­p¬]-@,a­ü©—%„$p(ä¤Ù¨×,úÁ(c‡¬p©¿¹&X£\Ç õ=²H°E¨;²4¥r0Ô()"'¤O(ú«@)Œ(=,Ÿk“&Yž¡¦$'‡-­)?,ô¨‚*a®°¤]-Ó­b¢]*´Â¡t¨+z“þ%	¬Û)5¬l*Þ'™¡T-a,0ï¤m¦ò)F*@¤-«&,7®ï%b%›'P"y$g¤ƒ)æ™‰&·,¡¨F'f$?¬p)%­Ý¨+‚!…«¬2²\¨§*¡°¯0H¢†'ï¯è*0(öœ?"ò-®30'Ü¤“+í­B¥4™è)t«¨,™¬ â(œ K/b¡(¬­,©I¬Ö¬%(Œ«^¥¥­Ä«­±µ)@­(õ¥l1Å¤¿¨­S%S+¹ªà©´$Q±õ%ÿ‰¡Õ(o­+)ªE‰j¤0°.§w)N§ž¬Ø-C)%¤o*’,%‚­…(©§§ˆªÇª#Ð&ß-,0àŸÔ*	%¬½©¹,6,«V,ï0Ë¢[¦€*:¦8.Þ¦'p¬ÿ#0 &8¢Ã¬V"p§™ÎŸf¯ú®)£L <¬n¦*¬”m*ý±…¥3.$6©; @°‡°¹®&-ÎÆ¨ª^&D./•ª(#¦Û­#¬x«¯¢Š¨Žª0*õ¬î¤ ¥)$J&S)Ä®ˆ !¡›ª%žb¯e"x¹-æ¢‹¯Ï¥œ*_¤ÂªÉ­Å¬€žÙ¬D¨+n(c©q¬X&ÙJ¯¿'v#Æ0´'/¢Ç&f*Þ)°·©¦ 1'$)|­)µs""ªç©¾®åL¢„%Ç¬0ªc)‰§±¨*¥,­Û)¼&²'š™š­¡ u-è¬«­ê¦ö(Î­€¤W$†¥å¨5±*Z£(¬¶¬H­â«®s­›¤`°­Ô ”®°©«*$+æ­-.^á(P¨þ)(*©x%©#¢?*,·p) )@Ý«E«k¯ã¨A*1)‘¬°°F£ä«Î%’.o&¬I¤k(}­§à$0¦§Å()¥\%…#j¤+©,Ñ&Ð%ëœÙ-ç-+.ø&úªŸ[v"Ü,µ¤¨Ý/î,òª'?(Á,™¢8)X¤â­)ñ)1)W®j©Lª¨=¬Ä®Þ¬p©ï®I“Ûª’'à©8)t­¤D,¼)Z g$G(­õ¬ß ¡èªî$ù,V+ªŽ)¶*õ&Â)ÔªÃ¦#:+q&’¤à¨{'[®>ª—«Þ¥S¨¦¨F&f¨Ã%?¨	¬j¥ä",JªÏ*9)‚¯$¢'}¨à¨¦¨º**Í­Ø–¤*=,©.¦e¬)S%o™ì*„!&&$žù#Ã.À(¦-(ü«/)Ö§Ó¡Õ% ­ªg©2¥‰ A ¢¢)«‚(O§[šû%™!­·°®¬ˆ!Í®iª:1S q¨ý¤K ´­{)gŸ:¡’¬Å­`±S'­l£H¢()!,)¬©h(ªzª‹(¬X®Z­=©¸'g&£ö­²ª6*¾*»¤—#ù)Ÿ¥b)#¥[c d)W¬#%’¦µ£W­Ò¤³'0£2)•¢R«l)þ =!+K§#'â#ú,«¨Þ©ÚŸè%ß «,°¬70)Ê¬z$*ÁÐ«´Ÿ"ªº2â­x¢T.$ ;«A!¡,>,©&
¤y­p!t¥«a«²s°©¥˜$²*Ð«	­a0ñ'¿'(C¨Jª§ «è›ú¨(‡*©,Ë©(,T(E‘ê­m¬M,´°œ*d.*Ïž.0b¨˜¬€°Rd í¬Ú¨’–¨®c.¤­‹ž,¦g®;®`(N¬t¡õ¨,¡#y O L¬[)f¤,†­!§·©%.ë 
(†'«Ö#d*b©à(ò+w+¥%è¬Ì"™-îªG¦K-*ª0¬5®,’(¿$²)#Ž°–ªQ­ö­È)œ¬%¤5,¨E¡ê)C*¼(¥,¢¬£%%Ý(»¡­¨«™ú©²8$Y-Ç(Y<¨½¤F.ù«Iª»¨o¦§$Q¬ã'h$·)Á¨‰©"L°[©$ž+é+¥æ,Ü¬s&A!C$¹«ë+Ú,;«{)ž™!žx*áh¥Ñ,W©n©Ï*õ$bª¨(”=¥~”)fì¦†#õ-Êªˆ¢€¬°*H—,Zª,U*EªÝ¥û,û(“$9¬u.~ªo*ç"µ-Ú¬,(¨‘®‡¥Í!c,Ú¥H¨¨£'>¬E/9¯c¨¦,¬*p$±(È!¨#|¢Îð®s§#ªÛ®å£Ä­è£v+¯*ÔªŸ 9Ü*~¥(¢© ª.V¦§±)§©@Ñ!].=+ï­ü­5§…¢¨€€d™+"+Š%E+8Ÿî¬/"ªÎ¥­¡¶ªp!ˆ,Y)¬¬z­¦-©*"¯»'*®i,©ª¬¶…*¿&$¬L)r-Ì¢Ÿ(¦(†(£ªL§’¨)'X(…#]¡o©¯É$9£¯«é¨ï+1¬(Æ 1©µ)´¨ç˜[£ä%
 T(8"#"Ö •!³!Ý¢#œ, J$í)¹ ë©Â"O-°h¢H¬`­Å¨ ¨.16(·©,.z¬Ç-_Ÿ¢Â R¥Z D%,%Ÿ£6'²£ó©¦0Î(†™ý”%¡þ)*¯t¨eŸ­Û©ª&+›ª£¦'œø­t¤äžž…¦-/% ß(}­)",Êªÿ  ,Áb&â¥%Á|(p­8­m¬7±P+F(‡)Ã'¸«(+p'7¥š(0”ä/8¦]ª¨±¬)Ú«Ñ¢Â'ø¥³£­ò¨t(C¥¼«£A¥â$¥¡g­%T(4­_'*®Ÿ«©°q¯®‡°V¬I"/ÁR)Õ´!M©¢"„©ƒ1Ëª·ª}./Ÿ.-2Ù™_¢V.Yª“!y¬*¢,Þ%O-¨ Î)d®Ù¥Ó§Î•w¬_¦¤)m-*'¬I-½Ÿ‘(«¼­ª-E§-‹­‡(%¥–&çí(‡¬o(g©Ý Æ&€(°#3 Mß¥.£B£ y“)æ º¥×ª>¬Û,K­",·+ÿ+E/9)s.7°ªk.s%`ªP+¬ª e('T%¬¾ªµ,­¥
t®ì¦µ+å.·,°ê)V±E,‚¨¡¦n¬5¨ñ•#©°K+#¨¬&$¥#Ù¢}%Ò©¸¨,[,¡ªÖ®ÿ³,‡&‚#î©¹¬V¨Œ-.‡¬•&Û"¯´%{¡2¬k(q¨Ñ $Ãöªê§²*%,!$G¥Ø(¦Á)á!­$¤-¯,Þtš-°°S¦½®sœ,Š,i Þ¢\£!$Ð¡X$g"Ü£á›%«!©€˜S–Î‰­"Î—ú©l¥—¤Ú!%Ý†;$˜)i¯:­¨.)å0—ªÊ(>°f°á$F'<&n#(,:¬¥'£¤G%<(S­(©/©ªÉ&XŸ¬$ê§äªÙ,L"}(¦Š(«'-« "ÒÁ¬ý¥c¥n¬H©x$–¤l«k©‹¥)¤•(,)¦¼¢(V«I›[¨ý%Ç¬Ì)í&*­°	08§Ñ°Œ,‚¨®*X¯^¤m-c¨s¨— k¨-ž¥n(*½¡Œ*Ü«V*»& $³#-¨¾)G';ª8­R«I*K¬·+m¡÷¨õ%¢¦-Ç/¹¬óž¬-Ö«5¯$)˜¬î¨¦?.M˜]&:(Œ¤žŠÍ¤S.R¥Þ–¹(‡¨¨I®£ñœP¬¶µ©.ª6"Ü«å¤Ï-'(:ªZ. .Ä*Á*&%¦å§úL™·¨¥š°j¥t©4¬¸)ö&«à¨ì¤•¯›¦ê£p¥y›$€ªð­n+r°R-]'‰&h )¥¦K/³0Å+Äª’(%;©v,ó¨º­®®z%^¥W¨É©8¤Ô«)Þ¦ö!°*ø'Ó¦ ¦0¨ø¢*Y©$÷,Øž®›Y¨
*é*H¦Ó%¾(¥û*a.a©
-r"  .*?&Ä&×«—§ !º­Ò"¨±&ú$Ú¢Z§ë"ø 4¯X&H$µ®€'¬|¨O$,¬n¦(§É)/­Ižb®Š°ä)R$…§­ò°º(ô¡àšY'k'ç#¦F¬­q)=“f¥ß)V¬	(Ú)«¦e¦,	-“t£¦*ç¤Õp)ù¢L(’¨‹®§±l¯Ü(Ô® ªŸ(,¥N!|-­®¿)/œµ#9¬úªÛ«-¿,N/,Ö%}.¬,¨÷-ç¤Ó+)(©¡(X¤£¨®¸Ý$)5¤E« ­%A0%, è$.&ªÒ*ß+J$f§vª»¡q¬;¦†&zž­×£Y°S,QÖ›Ô¡½ª1q)h,&,§ªL¦_%*­4!Š,‹&¡å¬Í©·+3¯x(z+¥.S1x)<¨f¦Ï%Ë™Ü!tšª­4™oŸ‹)&*M¨, $¢(Q£€+ò#L©»­	-Ý&4¬}+ª‡ªX,È­™¡<*® $ÅM •.:©])-¦á'Q$)ÊÜ%^%ˆ£‚&Âžê©­«E®µ,#Å"ˆ±¤¨Ì©[¦r¤C,«GªK)d)Ø¬)±£&ö'(”©ó¤¢&Y Ëšy':.g-E!ÿt­2©w(/­*¬/Ë¨p(o¬Eª%–*ª©:¦{&"*f°Â«¢T$¢©ë¢®)i+e‡&*©¸©™d¬g,þ&f  .ò,¬a­Š©“-™¨Q&¿©Ê­®+Ñ.|£¨¯}%‘ªa'Å¥-áªQ¨†(5+R«